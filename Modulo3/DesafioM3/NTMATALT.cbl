      ...
      *VE SE O ARQUIVO EXISTE, ENCERRA O PROGRAMA.
       ...
       P440-MOSTRA-MATERIA.
           ...
           END-DISPLAY.
           DISPLAY 'DESEJA ALTERAR O NOME DO MATERIA?'
           END-DISPLAY.
       ...
       P460-ALTERA-MATERIA.
           DISPLAY 'DIGIGTE O NOVO NOME DO MATERIA.............: '
           END-DISPLAY.
           ACCEPT NM-MATERIA
           END-ACCEPT.
           DISPLAY 'DIGIGTE A NOVA NOTA DE APROVACAO DA MATERIA: '
           END-DISPLAY.
           ACCEPT NT-APROVACAO
           END-ACCEPT.
           REWRITE REG-MATERIA
               INVALID KEY
                   PERFORM P800-ERRO   THRU P800-ERRO-FIM
               NOT INVALID KEY
                   DISPLAY 'MATERIA ALTERADO COM SUCESSO.'
                   END-DISPLAY
           END-REWRITE.
       ...
       P800-ERRO.
           ...
           IF WS-FS = 35
               ...
               END-DISPLAY
           ELSE
               DISPLAY 'NAO FOI POSSIVEL ATUALIZAR O MATERIA.'
               END-DISPLAY
           END-IF
           PERFORM P900-FINALIZA  THRU P900-FINALIZA-FIM.
       P800-ERRO-FIM.
