      ...
      ******************************************************************
           ...
           EVALUATE WS-OPCAO
               WHEN '1'
                   MOVE ' *** INCLUSAO DE MATERIA *** '
                                                   TO WS-COM-MENSAGEM
                   CALL
                   'D:\My Documents\Cobol\Programs\bin\NTMATINC'
                   USING LK-COM-AREA
               WHEN '2'
                   MOVE ' *** CONSULTA DE MATERIA *** '
                                                   TO WS-COM-MENSAGEM
                   CALL
                   'D:\My Documents\Cobol\Programs\bin\NTMATCON'
                   USING LK-COM-AREA
               WHEN '3'
                   MOVE ' *** ALTERACAO DE MATERIA *** '
                                                   TO WS-COM-MENSAGEM
                   CALL
                   'D:\My Documents\Cobol\Programs\bin\NTMATALT'
                   USING LK-COM-AREA
               WHEN '4'
                   MOVE ' *** EXCLUSAO DE MATERIA *** '
                                                   TO WS-COM-MENSAGEM
                   CALL
                   'D:\My Documents\Cobol\Programs\bin\NTMATEXC'
                   USING LK-COM-AREA
               WHEN '5'
                   MOVE ' *** LISTAGEM DE MATERIA *** '
                                                   TO WS-COM-MENSAGEM
                   CALL
                   'D:\My Documents\Cobol\Programs\bin\NTMATLIS'
                   USING LK-COM-AREA
               WHEN '9'
       ...
       P430-MONTA-TELA.
           ...
           DISPLAY '|<2> - CONSULTAR MATERIA      |'.
           DISPLAY '|<3> - ALTERAR MATERIA        |'.
           DISPLAY '|<4> - EXCLUIR MATERIA        |'.
           DISPLAY '|<5> - LISTAR  MATERIAS       |'.
