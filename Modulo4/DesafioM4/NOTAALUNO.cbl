      ...
      ******************************************************************
       ...
       01  TELA-DADOS.
           ...
           05 FILLER        PIC X(30)   USING WS-NOME-ALUNO.
           05 LINE 09 COLUMN 35.
           05 FILLER        PIC X(28)   VALUE
                            'DIGITE A DISCIPLINA.......:'.
           05 FILLER        PIC X(30)   USING WS-NOME-DISCIPLINA.
           ...
           05 FILLER        PIC X(28)   VALUE
                            'PRIMEIRA NOTA............:'.
           05 FILLER        PIC  99,9    USING WS-NOTA-1
                            BACKGROUND-COLOR 1.

           05 LINE 13 COLUMN 35.
           05 FILLER        PIC X(28)   VALUE
                            'SEGUNDA NOTA.............:'.
           05 FILLER        PIC  99,9    USING WS-NOTA-2
                            BACKGROUND-COLOR 1.

           05 LINE 14 COLUMN 35.
           05 FILLER        PIC X(28)   VALUE
                            'TERCEIRA NOTA............:'.
           05 FILLER        PIC  99,9    USING WS-NOTA-3
                            BACKGROUND-COLOR 1.

           05 LINE 15 COLUMN 35.
           05 FILLER        PIC X(28)   VALUE
                            'QUARTA NOTA..............:'.
           05 FILLER        PIC  99,9    USING WS-NOTA-4
                            BACKGROUND-COLOR 1.

           05 LINE 25 COLUMN 35.
       ...
       01  TELA-CONFIRMA.
           ...
           05 FILLER        PIC X(28)   VALUE
                            'NOVO CALCULO (S/N)?......:'.
           05  FILLER       PIC X(01)   USING WS-CONTINUA-CALC.
      ...
      * 01  TELA-APURACAO.
           ...
           05 FILLER        PIC X(28)   VALUE
                            'APURACAO DA MEDIA........:' .
           05 FILLER        PIC  99,9    USING WS-NOTA-MEDIA.

           05 LINE 23 COLUMN 35.
           05 FILLER        PIC X(28)   VALUE
                            'APROVADO / REPROVADO.....:'.
           05  FILLER       PIC X(10)   USING WS-RESULTADO.
